...
const styles = StyleSheet.create({
  ...
  progressRingOuter: { width: 100, height: 100, borderRadius: 50, backgroundColor: "rgba(0,0,0,0.05)", alignItems: "center", justifyContent: "center", marginBottom: Spacing.md },
  progressRingInner: { width: 80, height: 80, borderRadius: 40, alignItems: "center", justifyContent: "center", zIndex: 1 },
  progressRingFill: { position: "absolute", width: 100, height: 100, borderRadius: 50, opacity: 0.3 },
